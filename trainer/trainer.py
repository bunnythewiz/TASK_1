...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # The data is transformed and sent to the GPU.
    ...
    def _on_epoch_finish(self):
        ...
        if self.config['local_rank'] == 0:
            ...
            save_best = False
            if self.validate_loader is not None and self.metric_cls is not None:  # Using f1 as the optimal model index
